...
\begin{document}
  ...
  \section{Experience}
    ...
    \begin{onecolentry}
      \begin{highlights}
        ...
        \item Developed software for Nordic Semiconductor's devices to create solutions for Bluetooth Low Energy environments.
    ...
    \begin{onecolentry}
      \begin{highlights}
        ...
        \item Developed software for very small form-factor and low energy devices, and set up a continuous integration environment for the project.
  ...
  \section{Skills}
    \begin{onecolentry}
      \textbf{Hardware:} Schematic and layout design with KiCad, troubleshooting/measurements using oscilloscopes, logic analyzers, USB analyzers, multimeters, using microcontrollers from Atmel/Microchip/STMicroelectornics/Nordic Semiconductor/Texas Instruments and others. Experience with integrating AI/LLM-based tools (e.g. Continue/Openrouter, DeepSeek/Qwen/GPT-5.6) to workflows.
    \end{onecolentry}
    \vspace{0.3 cm}
    \begin{onecolentry}
  ...
  \section{Projects}
    \begin{twocolentry}{
      \href{https://github.com/SakuGlumoff/iida-devkit}{\faIcon{github} SakuGlumoff/iida\-devkit}
    }
    \textbf{Iida devkit}
    \end{twocolentry}
    \vspace{0.1 cm}
    ...
    \vspace{0.3 cm}
    \begin{twocolentry}{
      \href{https://github.com/SakuGlumoff/linux-sbc}{\faIcon{github} SakuGlumoff/linux-sbc}
    }
    \textbf{Linux SBC}
    \end{twocolentry}
    \vspace{0.1 cm}
    \begin{onecolentry}
      \begin{highlights}
        \item A PCB design exercise using KiCad for hardware and Yocto for software.
        \item The result is a single board computer with a Linux operating system, which can be used for different purposes.
      \end{highlights}
    \end{onecolentry}
    \vspace{0.3 cm}
    \begin{twocolentry}{
